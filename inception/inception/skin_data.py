...
# ==============================================================================
"""Small library that points to the skin data set.
"""
...
class SkinData(Dataset):
  ...
  def download_message(self):
    ...
    print('Failed to find any skindata %s files'% self.subset)
    print('')
    print('If you have already processed the data, then make '
